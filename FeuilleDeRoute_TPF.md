...
* Certains termes sont à mettre en valeur dans le texte, notamment pour concerver une certaine marque d'oralité. Afin d'harmoniser ce type de mise en valeur, je vous recommande de concerver uniquement l'italique. Cela permettra de libérer les guillements. Vous pourrez donc utiliser les guillements français pour les citations, et les guillements anglais pour les ajouts qui ne sont ni des mises en valeur, ni des citations (ex. "L98" à la page 19 du PDF.)
