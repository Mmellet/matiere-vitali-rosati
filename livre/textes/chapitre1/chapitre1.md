...
Mais *δεινός* est aussi l'adjectif utilisé par Socrate dans le _Banquet_ pour parler de l'amour (*δεινὸς γόης*, `\Plato [Banquet]{203}[d]`{=latex}). L'amour dépasse aussi l'humain, mais parce qu'il est divin, ou mieux, parce qu'il est un dieu.
...
<!--regrouper les deux phrases pour retirer la répétition de "je voudrais démontrer" pour une lecture plus fluide-->
...
<!--Suggestion de mettre des informations se trouvant dans la note de bas de page directement dans le développement même de l'essai, notamment la définition de l'approche de l'auteur, cette information doit être visible pour le lecteur--> 
